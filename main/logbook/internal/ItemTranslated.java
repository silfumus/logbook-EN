 ...
 *
 */
public final class ItemTranslated {
    ...
    private static final Map<String, String> ITEMTRANSLATED = new ConcurrentHashMap<String, String>() {
        {
            ...
            this.put("12.7cm単装砲", "Type 97 Torpedo Bomber (931 Air Group)");
            this.put("瑞雲(六三四空)", "Zuiun (634 Air Group)");
            this.put("瑞雲12型", "Zuiun Model 12");
            this.put("瑞雲12型(六三四空)", "Zuiun Model 12 (634 Air Group)");
            this.put("九七艦攻(九三一空)", "Type 97 Torpedo Bomber (931 Air Group)");
            this.put("天山(九三一空)", "Tenzan (931 Air Group)");
            this.put("2cm 四連装FlaK 38", "2cm Flakvierling 38");
            this.put("3.7cm FlaK M42", "3.7cm FlaK M42");
            this.put("艦艇修理施設", "Ship Repair Facility");
            this.put("新型高温高圧缶", "New High Pressure-Temperature Steam Boiler");
            this.put("22号対水上電探改四", "Type 22 Surface RADAR Kai4");
