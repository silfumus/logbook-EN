    ...
    private static final Map<String, ShipInfoDto> SHIP = new ConcurrentHashMap<String, ShipInfoDto>() {
        {
            ...
            this.put("207", new ShipInfoDto("綾波改", "駆逐艦", "あやなみ", 0, 20, 15));
            ...
            this.put("211", new ShipInfoDto("榛名改", "戦艦", "はるな", 0, 120, 90));
            ...
            this.put("222", new ShipInfoDto("川内改", "軽巡洋艦", "せんだい", 0, 30, 25));
            ...
            this.put("265", new ShipInfoDto("妙高改", "重巡洋艦", "みょうこう", 0, 70, 40));
            this.put("266", new ShipInfoDto("那智改", "重巡洋艦", "なち", 0, 70, 40));
            this.put("267", new ShipInfoDto("足柄改", "重巡洋艦", "あしがら", 0, 70, 40));
            this.put("268", new ShipInfoDto("羽黒改", "重巡洋艦", "はぐろ", 0, 70, 40));
            ...
            this.put("279", new ShipInfoDto("蒼龍改", "正規空母", "そうりゅう", 0, 65, 65));
            this.put("280", new ShipInfoDto("飛龍改", "正規空母", "ひりゅう", 0, 65, 65));
            this.put("281", new ShipInfoDto("龍驤改", "軽空母", "りゅうじょう", 0, 40, 40));
            ...
            this.put("581", new ShipInfoDto("ナガラ級", "軽巡洋艦", "mist", 0, 0, 0));
            this.put("582", new ShipInfoDto("タカオ", "重巡洋艦", "mist", 0, 0, 0));
            this.put("583", new ShipInfoDto("マヤ", "重巡洋艦", "mist", 0, 0, 0));
            this.put("584", new ShipInfoDto("ハルナ", "戦艦", "mist", 0, 0, 0));
            this.put("585", new ShipInfoDto("キリシマ", "戦艦", "mist", 0, 0, 0));
            this.put("586", new ShipInfoDto("コンゴウ", "戦艦", "mist", 0, 0, 0));
